...
#    print("text_width, text_height) is ",text_width, text_height)
    ...
    for i, w in enumerate(words):
        ...
        #draw bounding box
        x0=sum(words_width[0:i]) + i * int(space_width)
        y0 = 0
        x1=sum(words_width[0:i]) + i * int(space_width)+ text_width
        y1=text_height
#        txt_draw.rectangle((x0,y0, x1,y1), fill=None, outline=None, width=3)
#    txt_draw.rectangle((0,0,text_width, text_height), fill=None, outline=None, width=3)
